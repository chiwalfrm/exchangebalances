...
if my_api_subaccount != '':
        ftx = client.FtxClient(api_key=my_api_key, api_secret=my_api_secret, subaccount_name=my_api_subaccount)
else:
        ftx = client.FtxClient(api_key=my_api_key, api_secret=my_api_secret)
